---
title: 解構 AI 新浪潮：從語言模型邁向「多模態 AI 代理」
track: 上午・主題演講
order: 2
speakers:
  - name: Ed Chi 紀懷新
...
![Google DeepMind 紀懷新「解構 AI 新浪潮」場次開場投影片](/activities/cloud-day-2026/s02-1.webp)

## 推薦系統的「古典」設定：作為對比基準

![經典的 User-Item 評分矩陣投影片：以《星際大戰》為例，Given 已知的 (user, item) 評分，Find 一個能預測缺失評分的模型](/activities/cloud-day-2026/s02-2.webp)
...
![Google 基礎模型三個突破里程碑投影片：2012 Deep Learning（貓臉辨識）、2014 Sequence to Sequence Learning、2017 Attention Is All You Need（Transformer）](/activities/cloud-day-2026/s02-3.webp)
...
![Google DeepMind 投影片：傳統典範是 Next Token Prediction，新興典範是 Next Idea Prediction，理論基礎為 Schemata Theory](/activities/cloud-day-2026/s02-4.webp)
