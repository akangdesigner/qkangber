...
export const SERVICES_DETAIL: ServiceDetail[] = [
  {
    ...
    platforms: ['Shopify', 'WooCommerce', '黑貓物流', '7-11', 'LINE'],
    metric: { before: '每筆 10 分鐘', after: '< 30 秒', label: '處理時間' },
    kpis: [['每筆訂單處理時間', '8–12 分鐘', '< 30 秒'], ['人工出錯率', '3–5%', '< 0.1%'], ['客服詢問量', '基準', '−40%']],
    problem: '每天手動複製訂單到倉儲系統、通知物流、更新庫存——這些重複性操作不只耗時，還容易出錯。一旦訂單量上升，人力成本直線暴增。',
    flowLabel: '自動化流程',
    flow: [
      { title: '訂單觸發', desc: '新訂單成立，n8n 立即接收通知（支援 Shopify / WooCommerce / 91App）' },
    ...
    faq: [
      { q: '支援哪些電商平台？', a: '支援 Shopify、WooCommerce、91App，其他平台只要有 API 或 Webhook 都可以評估串接。' },
...

  {
    ...
    price: 'NT$ 4,000', priceNote: '依數據源數量與報表複雜度調整',
    faq: [
...

  {
    ...
    kpis: [['追蹤覆蓋', '60%', '100%'], ['跟進延遲', '1–3 天', '< 5 分'], ['轉換率', '基準', '+35%']],
