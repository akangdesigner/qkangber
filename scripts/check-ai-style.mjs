...
const RULES = [
  ...
  [/<h[23][^>]*>[^<]*長(什麼|怎)樣/g, "A 懸念標題", "「…長什麼樣」吊胃口標題，改成直接說要分享什麼＋吃關鍵字"],
  [/<h[23][^>]*>\s*先(搞懂|弄懂|了解|認識|理解|搞清楚)/g, "A 懸念標題", "標題「先搞懂…」是對讀者下指令的報幕腔，直接講主題"],
