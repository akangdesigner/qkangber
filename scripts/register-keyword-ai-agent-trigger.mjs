// 在「關鍵字編列」分頁登記 ai-agent-trigger 這篇的主攻字。
// 用法：node scripts/register-keyword-ai-agent-trigger.mjs [--write]
import fs from 'fs'
...
const KW = 'ai agent 觸發'
const NEW = ['F AI 定義(FAQ)', KW, '資訊(定義)', 'ai-agent-trigger ✅ 已上架', '低(待驗)', '低', '中']
...
console.log(`✓ 已登記：${KW} → ai-agent-trigger（排序 ${maxOrder+1}）`)
