// 發布 16-ai-website-development 到 posts 分頁。
// 用法：node scripts/publish-ai-website-development.mjs [--write] [--update]
...
const SLUG = 'ai-website-development'
const TITLE = '2026 AI 網站開發怎麼開始？不會寫程式也能打造專屬自己的網站'
const DATE = '2026/06/29'
const TAGS = 'AI 網站開發,不會寫程式建站,Vibe Coding,Claude Code,Cursor'
const EXCERPT = '不會寫程式也想要一個專屬網站？這篇 AI 網站開發指南用白話帶你搞懂什麼是 Vibe Coding，並實測比較 Claude Code、Cursor、Codex 三個工具，帶你從零到上線做出自己的網站。'
const CATEGORY = 'AI 軟體開發'   // M 主分類（扁平 5 類）
const SUBCATEGORY = ''            // O 副分類已退役，留空
const COVER = 'https://i.ibb.co/VY4K7c5J/cover.webp'

// --- 內文轉換 ---
const raw = fs.readFileSync('blog-drafts/16-ai-website-development/16-ai-website-development.html', 'utf8')
...
console.log(`內文長度=${content.length}｜<img>=${leftover.imgs}（應 6：封面＋5 內文圖）`)
