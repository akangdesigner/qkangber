// 裁切＋標註 /doctor 截圖：去掉頂部分頁列與上方另一段對話，紅框＋編號三個重點
import path from 'path'
import sharp from 'sharp'
import { chromium } from 'playwright'

const RAW = 'C:/Users/asdto/OneDrive/桌面/1.png'
const OUT = path.resolve('D:/qkangber/blog-drafts/26-claude-code-commands/images/screenshot-doctor.jpg')
const CROP_TOP = 176
...
const BOXES = [
  { n: 1, x: 2, y: 2, w: 110, h: 26, r: 6, badge: 'right' },        // /doctor 指令行
  { n: 2, x: 2, y: 38, w: 800, h: 28, r: 6, badge: 'right' },       // 唯讀探測說明
  { n: 3, x: 2, y: 166, w: 1156, h: 182, r: 8, badge: 'right', bx: 1130, by: 354 }, // Review your answers 提案＋綠字決定（球放框外右下）
]
